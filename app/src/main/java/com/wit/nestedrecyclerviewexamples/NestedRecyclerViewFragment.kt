...
import com.wit.nestedrecyclerviewexamples.databinding.FragmentNestedRecyclerViewBinding
import com.wit.nestedrecyclerviewexamples.databinding.ListItemBinding

class NestedRecyclerViewFragment : Fragment() {
	private val listAdapter = ListAdapter()
	private lateinit var viewBinding: FragmentNestedRecyclerViewBinding

	override fun onCreateView(
			inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
	): View {
		viewBinding = FragmentNestedRecyclerViewBinding.inflate(inflater, container, false)
